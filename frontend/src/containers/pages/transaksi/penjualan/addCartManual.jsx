        ...
        />
        {
          ...
          <div className="flex-container flex-column pos-rel bodyAutoComplate">
            <ul className="list-group list-group-flush">
              {
                barang.filter(({ kodeBarang }) =>
                  kodeBarang.indexOf(props.kodeBarang) > -1
                )
                  .map((v, i) => (
                    <li key={ i } onClick={ () => { handleAutoKodeBarang(v.kodeBarang) } } className="list-group-item listAutoComplate" > { v.kodeBarang }</li>
                  ))
              }
            </ul>
          </div>
        ...
        />
        {
          ...
          <div className="flex-container flex-column pos-rel bodyAutoComplate">
            <ul className="list-group list-group-flush">
              {
                barang.filter(({ nama }) =>
                  nama.indexOf(props.namaBarang) > -1
                )
                  .map((v, i) => (
                    <li key={ i } onClick={ () => { handleAutoNamaBarang(v.nama) } } className="list-group-item listAutoComplate" > { v.nama }</li>
                  ))
              }
            </ul>
          </div>
