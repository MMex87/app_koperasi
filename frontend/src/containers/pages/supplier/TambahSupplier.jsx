        ...
        return (
            <main id="main" class="main">
                <div class="pagetitle">
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"> <Link to="/supplier">Data Supplier</Link> </li>
                            {
                                judul == 'Tambah'
                                    ?
                                    <li className="breadcrumb-item"> Input Supplier </li>
                                    :
                                    <li className="breadcrumb-item"> <Link to="/supplier/tambah" onClick={ () => this.setState({
                                        nama: '',
                                        alamat: '',
                                        noHP: ''
                                    }) }>Input Supplier</Link> </li>
                            }
                            {
                                judul == 'Edit'
                                &&
                                <li className="breadcrumb-item"> Edit Supplier</li>
                            }
                        </ol>
                    </nav>
                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form onSubmit={ tambah }>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="nama" value={ this.state.nama } onChange={
                                                    e => this.setState({ nama: e.target.value })
                                                } />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="noHP" value={ this.state.noHP } onChange={
                                                    e => this.setState({ noHP: e.target.value })
                                                } />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="alamat" value={ this.state.alamat } onChange={
                                                    e => this.setState({ alamat: e.target.value })
                                                } />
                                            </div>
                                        </div>
